  ...
  <div class="table-container">
    ...
    >
      ...
      <el-table-column
        show-overflow-tooltip
        prop="accountId"
        label="玩家账号ID" width="90">
      </el-table-column>
      <el-table-column
        prop="updateTime"
        label="充值时间" width="160">
      </el-table-column>
      <el-table-column
        show-overflow-tooltip
        prop="referer"
      ...
      <el-table-column
        show-overflow-tooltip
        prop="oneLevelAgentsId"
        label="一级代理ID" width="100">
      </el-table-column>
      <el-table-column
        show-overflow-tooltip
        prop="topAgentsId"
        label="顶级代理ID" width="100">
      </el-table-column>
      <el-table-column
        show-overflow-tooltip
        prop="appPrice"
...
<script>
  ...
  import { getPlayerOrderList } from '@/api/playerOrder'
